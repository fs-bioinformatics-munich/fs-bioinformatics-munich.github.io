...
:::tip
Hier findest du hauptsächlich Resourcen, die wenig bis keine Vorkenntnisse voraussetzen. Wenn du größere Herausforderungen suchst, schau <a href={`${import.meta.env.BASE_URL}/de/students/link-collection#nützliche-externe-resourcen`}>hier</a> vorbei!
:::
