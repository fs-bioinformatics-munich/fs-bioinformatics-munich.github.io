...
Zudem hat Eure Wahl des Mathe/Info-Zweigs (also TUM/LMU-Zweige) im 1. Semester einen großen Einfluss darauf, wo eure Hauptstandorte sein werden. Mehr dazu [hier]({`${import.meta.env.BASE_URL}de/prospectives/program-contents#computer-sciencemathematicsstatistics`}).
