...
:::tip
Here you will mainly find resources that require little to no prior knowledge. If you are looking for greater challenges, check [here]({`${import.meta.env.BASE_URL}en/students/link-collection#useful-external-resources`})!
:::
